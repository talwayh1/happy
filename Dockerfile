...
# auto-install-peers=false: tsx bundles esbuild, doesn't need typescript peer dep (saves 23 MB)
# rm prisma CLI: @prisma/client's optional dep pulls it in despite being in devDeps (saves 51 MB)
